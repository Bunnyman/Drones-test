...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Two stacked rows: filters on top, time controls below. */
  .bottombar {
    display: flex; flex-direction: column; gap: 8px;
    font-family: var(--font-mono);
  }
  .filter-bar, .time-bar { display: flex; align-items: center; gap: 10px 14px; flex-wrap: wrap; }
  ...
  /* Filter pills — filled when active, grey when not. */
  .pill {
  ...
  <div class="scrubber">
    ...
    <div class="bottombar">
      ...
      <div class="time-bar">
        ...
        <span class="readout-inline" id="winRange" style="margin-left:auto">&mdash;</span>
      </div>
    </div>
  </div>
</div>
