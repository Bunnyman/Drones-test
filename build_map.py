...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Single compact row: filters on the left, time controls on the right. */
  .bottombar {
    display: flex; align-items: center; gap: 14px; flex-wrap: wrap;
    font-family: var(--font-mono);
  }
  .filters-left, .time-right { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; }
  .filters-left { flex: 1 1 auto; min-width: 0; }
  .time-right   { flex: 0 0 auto; margin-left: auto; }
